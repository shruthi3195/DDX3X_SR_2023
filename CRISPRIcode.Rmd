...
setwd("/lab/solexa_page/shruthir/DDX3KD_RNAseq/output7doublekdtrimmed/")
...
```{r}
setwd("/lab/solexa_page/shruthir/Paper_Code/")
myList <- matrix(c("Control","DDX3X_kd","Control","DDX3Y_kd"),ncol=2, byrow = TRUE)
